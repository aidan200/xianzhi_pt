    ...
    <script type="application/javascript">
        ...
        $(document).ready(function () {
            ...
            if('${discuss.discussId }'!=0){
                saveForm.action = "${pageContext.request.contextPath}/Discuss/updateDiscuss.emp";
            }
        });
    </script>
</head>
...
<div class="content">
    <div class="header">
        <h1 class="page-title">添加/修改评论信息</h1>
    </div>
            ...
            <div class="well">
                ...
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane active in" id="home">
                        <sf:form id="saveForm" action="${pageContext.request.contextPath}/Discuss/saveDiscuss.emp" modelAttribute="discuss" >
                            <sf:hidden  path="discussId" />
                            <c:if test="${discuss.blogId != null}">
                                上级博客编号:<br>
                                <sf:hidden path="blogId"/><br>
                                <input type="text" name="blogId" value="${discuss.blogId}" disabled="disabled"><br>
                            </c:if>
                            评论人:<br>
                            ...
                            <br>
                            评论内容:<br>
                            <sf:textarea path="discussArticle"/><br>
