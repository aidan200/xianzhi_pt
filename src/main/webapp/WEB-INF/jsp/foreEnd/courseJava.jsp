...
<head>
    ...
    <script type="application/javascript">
        ...
        function jump(id) {
            ...
            window.location.href = "${pageContext.request.contextPath}/XzVideo/playVideo.do?videoID=" + id;
        }
    </script>
</head>
<body>
...
<div class="courses_banner">
    <div class="container">
        <h3>JAVA</h3>
        <p class="description">Java是一门面向对象编程语言，不仅吸收了C++语言的各种优点，还摒弃了C++里难以理解的多继承、指针等概念，因此Java语言具有功能强大和简单易用两个特征。</p>
        <div class="breadcrumb1">
            <ul>
                <li class="icon6"><a href="${pageContext.request.contextPath}/">首页</a></li>
                <li class="current-page">JAVA</li>
            </ul>
        </div>
    </div>
</div>
