...
<div class="courses_banner">
    <div class="container">
        ...
        <div class="breadcrumb1">
            <ul>
                <li class="icon6"><a href="${pageContext.request.contextPath}/XzVideo/boughtRecord.do">已购视频</a></li>
    ...
    <div class="in_white2">
        <div class="vip_nav">
            <ul class="col-md-2 col-xs-12" style="padding-right: 40px">
                ...
                <a href="${pageContext.request.contextPath}/XzVideo/boughtRecord.do" class="view_w"><li class="vip_li active">已购视频
                </li></a>
        ...
        <div class="col-md-10 col-xs-12">
            <sf:form id="videoManageForm" action="${pageContext.request.contextPath}/XzVideo/boughtRecord.do"
