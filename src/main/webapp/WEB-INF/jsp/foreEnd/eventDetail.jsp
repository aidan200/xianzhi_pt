...
<div class="courses_box1">
    <div class="container">
        ...
        <div class="col-md-9 detail">
            ...
            <p>${event.eventArticle}</p>
            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">

            </div>
            <div class="author-box">
                <div class="author-box-left"><img src="${pageContext.request.contextPath}/dist/foreEnd/images/t13.png" class="img-responsive" alt=""/>
                </div>
                <div class="author-box-right">
                    <h4 class="MM">主办方:&nbsp;&nbsp;&nbsp;${event.eventBy}</h4><br>
                    <span>活动时间：
                        <fmt:formatDate  value="${event.startTime}" type="both" pattern="MM-dd HH:mm" />&nbsp;&nbsp;至&nbsp;&nbsp;
                        <fmt:formatDate  value="${event.endTime}" type="both" pattern="MM-dd HH:mm" />
                    </span><br><br>
                    <span>举办地：${event.eventPlace}</span><br><br>
                    <span>活动类型：${event.eventType}</span><br><br>
                    <span class="m_1">发布者：${event.eventWriter}</span>
                </div>
                <div class="clearfix"></div>
            </div>
